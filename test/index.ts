...
describe('Test', function () {
    ...
    it('Confirm Test', async function () {
        ...
        await validator.addValidator(signers[1].address)
        await validator.addValidator(signers[2].address)
        await validator.addValidator(signers[3].address)
        await validator.addValidator(signers[4].address)
